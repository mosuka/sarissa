 ...
 *
 * Used together with `JapaneseAnalyzer.fromBytes()` to enable
 * Japanese morphological analysis in browser WASM, where filesystem-based
 * dictionary loading is not available.
 *
 * @module opfs
 */
