...
| [`geo3d/`](./geo3d/) | Live satellite positions (CelesTrak elements, client-side SGP4) on a CesiumJS 3D globe. Demonstrates the `geo3d` field type with `geo3d_bbox(...)` and `geo3d_nearest(...)` queries — true ECEF 3D, including altitude. |
