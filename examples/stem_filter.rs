...
fn main() -> Result<()> {
    ...
    let tokens = create_test_tokens(&[
        "running", "runs", "ran", "runner", "programming", "programs", "programmer"
    ]);
    ...
    let custom_stemmer = SimpleStemmer::with_suffixes(vec![
        "ing".to_string(), "ed".to_string(), "ly".to_string()
    ]);
    ...
    let porter_filter = StemFilter::new();
    let tokens = create_test_tokens(&[
        "connected", "disconnected", "reconnected", "connection", "connecting"
    ]);
    ...
    compare_stemming_algorithms(&[
        "running", "beautiful", "optimization", "traditional", "itemization"
    ])?;
    ...
    let porter_filter = StemFilter::new();
    let tokens = create_test_tokens(&[
        "The", "developers", "are", "optimizing", "applications", "using", "advanced", "algorithms"
    ]);
    ...
    println!("Porter Stemmer:");
    println!("  • High accuracy for English");
    println!("  • Complex algorithmic rules");
    println!("  • Slower but more precise");
    println!("  • Good for research and analysis");
    
    println!("\nSimple Stemmer:");
    println!("  • Fast processing");
    println!("  • Basic suffix removal");
    println!("  • Good for real-time applications");
    println!("  • Less accurate but efficient");
    
    println!("\nIdentity Stemmer:");
    println!("  • No processing overhead");
    println!("  • Preserves original forms");
    println!("  • Good for exact matching");
    println!("  • Useful for debugging");

    println!("\n=== Use Cases ===\n");
    println!("Search engines: Porter or Simple stemmer");
    println!("Real-time chat: Simple or Identity stemmer");
    println!("Academic research: Porter stemmer");
    println!("Code analysis: Identity or Custom stemmer");
    println!("Multilingual apps: Identity + language-specific");
