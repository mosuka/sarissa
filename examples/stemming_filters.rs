...
fn main() -> Result<()> {
    ...
    let comparison_words = vec![
        "beautiful", "running", "flies", "programming", "traditional", "itemization"
    ];
    ...
    println!("  StemFilter (Identity): {}", 
        StemFilter::with_stemmer(Box::new(IdentityStemmer::new())).name());

    println!("\n=== Use Cases ===\n");
    println!("PorterStemmer:");
    println!("  • Academic and research applications");
    println!("  • High-precision text analysis");
    println!("  • Information retrieval systems");
    println!("  • Complex morphological analysis");
    
    println!("\nSimpleStemmer:");
    println!("  • Fast processing of large texts");
    println!("  • Basic search functionality");
    println!("  • Real-time applications");
    println!("  • Simple keyword matching");
    
    println!("\nIdentityStemmer:");
    println!("  • Exact match requirements");
    println!("  • Debugging and testing");
    println!("  • Languages without stemming rules");
    println!("  • Preserving original word forms");
