...
use crate::parallel_lexical_search::search_task::TaskResult;
...
impl MergerFactory {
    ...
    pub fn create(
        strategy: crate::parallel_lexical_search::config::MergeStrategyType,
    ) -> Box<dyn MergeStrategy> {
        match strategy {
            crate::parallel_lexical_search::config::MergeStrategyType::ScoreBased => {
                Box::new(ScoreBasedMerger::new())
            }
            crate::parallel_lexical_search::config::MergeStrategyType::RoundRobin => {
                Box::new(RoundRobinMerger::new())
            }
            crate::parallel_lexical_search::config::MergeStrategyType::Weighted => {
                Box::new(WeightedMerger::new())
            }
            crate::parallel_lexical_search::config::MergeStrategyType::Custom => {
