...
impl ParallelIndexEngine {
    ...
    fn create_batch_config(&self) -> crate::parallel_full_text_index::batch_processor::BatchConfig {
        crate::parallel_full_text_index::batch_processor::BatchConfig {
    ...
    fn process_partition_batch(
        ...
        options: &IndexingOptions,
        batch_config: crate::parallel_full_text_index::batch_processor::BatchConfig,
    ...
    pub fn metrics(&self) -> crate::parallel_full_text_index::metrics::IndexingMetrics {
    ...
    pub fn partition_statistics(
        ...
        Vec<(
            String,
            crate::parallel_full_text_index::writer_manager::IndexPartitionStats,
        )>,
    > {
    ...
    pub fn aggregated_statistics(
        &self,
    ) -> Result<crate::parallel_full_text_index::writer_manager::IndexPartitionStats> {
