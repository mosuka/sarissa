...
//!
//! This module contains the core `InvertedIndex` structure implementing the `LexicalIndex` trait.
...
use crate::lexical::index::inverted::types::{InvertedIndexStats, SegmentInfo};
