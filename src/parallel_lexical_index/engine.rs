...
use crate::parallel_lexical_index::metrics::{IndexingMetricsCollector, IndexingTimer};
use crate::parallel_lexical_index::partitioner::DocumentPartitioner;
use crate::parallel_lexical_index::writer_manager::{IndexWriterHandle, WriterManager};
...
impl ParallelIndexEngine {
    ...
    fn create_batch_config(&self) -> crate::parallel_lexical_index::batch_processor::BatchConfig {
        crate::parallel_lexical_index::batch_processor::BatchConfig {
    ...
    fn process_partition_batch(
        ...
        options: &IndexingOptions,
        batch_config: crate::parallel_lexical_index::batch_processor::BatchConfig,
    ) -> BatchProcessingResult {
        let mut processor = BatchProcessor::new(batch_config, 1);

        // Create a single batch from all documents
        let mut batch =
            crate::parallel_lexical_index::batch_processor::DocumentBatch::new(partition_index);
    ...
    pub fn metrics(&self) -> crate::parallel_lexical_index::metrics::IndexingMetrics {
    ...
    pub fn partition_statistics(
        ...
        Vec<(
            String,
            crate::parallel_lexical_index::writer_manager::IndexPartitionStats,
        )>,
    > {
    ...
    pub fn aggregated_statistics(
        &self,
    ) -> Result<crate::parallel_lexical_index::writer_manager::IndexPartitionStats> {
...
mod tests {
    ...
    use crate::parallel_lexical_index::partitioner::HashPartitioner;
