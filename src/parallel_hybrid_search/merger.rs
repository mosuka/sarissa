...
impl ParallelHybridResultMerger {
    ...
    pub fn merge(
        ...
        let all_doc_ids: Vec<u64> = keyword_map
            .keys()
        ...
        let mut merged_results: Vec<ParallelHybridSearchResult> = all_doc_ids
            ...
            .filter_map(|doc_id| {
                ...
                // Get document fields
                let fields = document_store.get(&doc_id).cloned().unwrap_or_default();
    ...
    fn calculate_combined_score(
        ...
        match self.config.merge_strategy {
            ...
            MergeStrategy::MaxScore => self.max_score(keyword_score, vector_similarity),
            MergeStrategy::ScoreProduct => self.score_product(keyword_score, vector_similarity),
        ...
        let explanation = ScoreExplanation {
            ...
            details: HashMap::from([
                (
                    ...
                    self.config.keyword_weight.to_string(),
                ),
                (
                    "vector_weight".to_string(),
                    self.config.vector_weight.to_string(),
                ),
            ]),
        };
    ...
    fn max_score(
        ...
        let explanation = ScoreExplanation {
            ...
            keyword_contribution: if kw_weighted >= vec_weighted {
                kw_weighted
            } else {
                0.0
            },
            vector_contribution: if vec_weighted > kw_weighted {
                vec_weighted
            } else {
                0.0
            },
    ...
    fn score_product(
        ...
        let explanation = ScoreExplanation {
            ...
            details: HashMap::from([("product".to_string(), combined.to_string())]),
        };
