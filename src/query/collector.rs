...
struct FieldScoredDoc {
    doc_id: u64,
    score: f32,
    field_value: crate::document::field_value::FieldValue,
    ascending: bool,
}
...
impl<'a> TopFieldCollector<'a> {
    ...
    fn get_field_value(&self, doc_id: u64) -> crate::document::field_value::FieldValue {
        ...
        if let Ok(Some(value)) = self.reader.get_doc_value(&self.field_name, doc_id) {
            ...
            crate::document::field_value::FieldValue::Null
        }
    }
